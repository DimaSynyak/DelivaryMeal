package com.design.yogurt.app.restaurant.menu;
...
import com.design.yogurt.app.restaurant.service.ChangeDateListener;
...
import com.design.yogurt.app.restaurant.thread.MainAsyncTask;
import com.design.yogurt.app.restaurant.thread.RegistrationOrLoginAsyncTask;
import com.design.yogurt.app.restaurant.thread.UploadPageAsyncTask;
...
//                okRegFormButton.setText(R.string.enter);
    ...
    public void addFilterData(){
        ...
        for (final FilterData filterData : filter.getFilterDataList()){
            if (filterData.getList() != null && filterData.getList().size() != 0){
                ...
                textView.setTextSize(dpToPx(18));
    ...
    public float dpToPx(float dp) {
        ...
        float px = Math.round( dp * displayMetrics.densityDpi/displayMetrics.xdpi + 0.5f);
        return px;
    }
